...
<body onload="ready()" background="register_background.jpg">
				...
				<tbody>
					...
					<tr>
						...
						<td><form:input path="confirmpassword" type="password"
								class="form-control" /> <form:errors path="confirmpassword"
								cssClass="error" /></td>
					</tr>
					<tr>
					<tr>
					...
					<tr>
						...
						<td><form:select class="form-control"
							...
							</form:select> <form:errors path="customercreditCardType" cssClass="error" /></td>
					</tr>
					<tr>
						<td><label>Enter Credit Card Number:</label></td>
						<td><form:input type="text" class="form-control"
								path="customercreditCardNumber" /> <form:errors
								path="customercreditCardNumber" cssClass="error" /></td>
					</tr>
					<tr>
						<td><label>Enter Driving License Number:</label></td>
						<td><form:input type="text" class="form-control"
								path="customerdrivingLicenseNumber" /> <form:errors
								path="customerdrivingLicenseNumber" cssClass="error" /></td>
					</tr>
					<tr>
						<td><label>Enter Driving License Expiry Date:</label></td>
						<td><form:input class="form-control" type="date"
								min="2000-01-02" path="customerdrivingLicenseDate" /> <form:errors
								path="customerdrivingLicenseDate" cssClass="error" /></td>
					</tr>
					<tr>
						<td><label>Enter Date Of Birth:</label></td>
						<td><form:input class="form-control" type="date"
								min="2000-01-02" path="customerdateofBirth" /> <form:errors
								path="customerdateofBirth" cssClass="error" /></td>
					</tr>
					<tr>
						<td><label>Enter Passport Number:</label></td>
						<td><form:input path="customerpassportNumber" type="text"
								class="form-control" /> <form:errors
								path="customerpassportNumber" cssClass="error" /></td>
					</tr>
